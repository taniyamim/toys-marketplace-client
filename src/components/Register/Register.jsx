                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={handleSignUp}>
                            ...
                            <div className="form-control mt-6">
                                <input className="btn bg-[#341948]" type="submit" value="Sign Up" />
                            </div>
                        </form>
                        <p className='my-4 text-center'>Already an user? <Link className='text-violet-400 font-bold' to="/login">Login</Link> </p>
